...
import styles from "../../CSSmodules/Skeleton/SkeletonSideBar.module.css";
  ...
  return (
    <div className={styles.sideBar}>
      ...
      <div className={styles.bottom}>
        <div>
          <img
            src="/iconsSkeleton/CheckBottom.svg"
            alt="img"
